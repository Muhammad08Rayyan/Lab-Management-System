          ...
          <div className="bg-white overflow-hidden shadow rounded-lg mb-6">
            <div className="px-4 py-5 sm:p-6">
              ...
              <p className="text-gray-600">
                Manage test requests, sample processing, and result entry for laboratory operations.
              </p>
            </div>
          </div>
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center">
                      <svg className="h-5 w-5 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M3 14h18m-9-4v8m-7 0V4a1 1 0 011-1h3M9 3v2m6-2v2m3-2h3a1 1 0 011 1v16a1 1 0 01-1 1H6a1 1 0 01-1-1V4a1 1 0 011-1z" />
                      </svg>
                    </div>
                  </div>
                  <div className="ml-5 w-0 flex-1">
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-md">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Test requests assigned to you for processing
              </p>
            </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <div className="text-sm text-gray-500">
                        Test requests and samples will appear here when available
                      </div>
                    </div>
                  </div>
                </div>
